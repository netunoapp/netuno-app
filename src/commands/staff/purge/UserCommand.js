...
exports.default = new Command_1.default("purge messages user", (_a) => __awaiter(void 0, [_a], void 0, function* ({ t, interaction }) {
    var _b;
    ...
    if (interaction.channel && interaction.channel.type === 0) {
        interaction.channel
            .purge({ limit, filter: (m) => m.author.id === user.id })
