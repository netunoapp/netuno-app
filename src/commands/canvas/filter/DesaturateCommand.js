...
exports.default = new Command_1.default("filter desaturate", (_a) => __awaiter(void 0, [_a], void 0, function* ({ interaction, t }) {
    var _b;
    ...
    const level = (_b = interaction.data.options.getInteger("level", false)) !== null && _b !== void 0 ? _b : 80;
    ...
    yield Canvas_1.default.desaturate(ctx, level, 0, 0, canvas.width, canvas.height);
