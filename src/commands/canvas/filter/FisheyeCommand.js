...
exports.default = new Command_1.default("filter fish-eye", (_a) => __awaiter(void 0, [_a], void 0, function* ({ interaction, t }) {
    var _b;
    ...
    yield Canvas_1.default.fishEye(ctx, level, 0, 0, canvas.width, canvas.height);
