...
exports.default = new Command_1.default("filter sepia", (_a) => __awaiter(void 0, [_a], void 0, function* ({ interaction, t }) {
    ...
    yield Canvas_1.default.sepia(ctx, 0, 0, canvas.width, canvas.height);
