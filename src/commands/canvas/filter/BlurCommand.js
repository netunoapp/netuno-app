...
exports.default = new Command_1.default("filter blur", (_a) => __awaiter(void 0, [_a], void 0, function* ({ interaction, t }) {
    ...
    yield Canvas_1.default.motionBlur(ctx, background, 0, 0, canvas.width, canvas.height);
