...
exports.default = new Command_1.default("roleplay pat", (_a) => __awaiter(void 0, [_a], void 0, function* ({ t, author, interaction }) {
        ...
        embeds: [
            {
                ...
                image: { url: yield new GifAPI_1.default().getPat() },
            },
        ],
        components: [
            {
