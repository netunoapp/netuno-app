...
exports.default = new Command_1.default("server member avatar", (_a) => __awaiter(void 0, [_a], void 0, function* ({ t, interaction }) {
    var _b, _c, _d;
    ...
    if (!member) {
        ...
        const url = member.avatarURL(member.avatar && member.avatar.includes("a_") ? "gif" : "png", 4096);
        if (!url) {
            interaction.createFollowup({ content: `${emojis_json_1.default.no} │ ${t["!member_avatar"]}` });
            return;
        }
