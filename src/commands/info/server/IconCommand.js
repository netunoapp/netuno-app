...
exports.default = new Command_1.default("server icon", (_a) => __awaiter(void 0, [_a], void 0, function* ({ t, interaction }) {
    if (!interaction.guild) {
        ...
        if (!url) {
            interaction.createFollowup({ content: `${emojis_json_1.default.no} │ ${t["!icon"]}` });
        }
        else {
