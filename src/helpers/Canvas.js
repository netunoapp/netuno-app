...
class CanvasUtil {
    static validImage(image) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const img = yield (0, canvas_1.loadImage)(image);
                return true;
            }
            catch (e) {
                return false;
    ...
    static roundRect(ctx, x, y, width, height, radius) {
        ...
        ctx.closePath();
        ctx.stroke(); // ou ctx.fill() para preencher
    }
    static round(url) {
        return __awaiter(this, void 0, void 0, function* () {
            const img = yield (0, canvas_1.loadImage)(url); // Carrega a imagem
    ...
    static greyscale(ctx, x, y, width, height) {
        ...
        for (let i = 0; i < data.data.length; i += 4) {
            const brightness = 0.34 * data.data[i] +
                0.5 * data.data[i + 1] +
                0.16 * data.data[i + 2];
